        ...
        <div class="card card-large">
          ...
          <div class="card-header">
                ...
                <div class="text-judul">
                  <strong>Kegiatan yang telah diikuti</strong>
                </div>
              </div>
          <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
            <div class="container-fluid">
              ...
              <div class="header-area text-left">
                <button class="btn btn-primary">Daftar Kegiatan Lainnya</button>
            ...
            <th><strong>Konversi</strong></th>
            <th><strong>Status Konversi</strong></th>
            <th><strong>JP Disetujui</strong></th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    <td>Pendidikan</td>
                    <td><span class="status">Telah Terlaksana</span></td>
                    <td><span class="stk1">Konversi JP</span></td>
                    <td><span class="statuss">Dokumen Sedang Diverifikasi Admin OPD Penyelenggara</span></td>
                    <td>20</td>
                  </tr>
                </tbody>
                  <tbody>
