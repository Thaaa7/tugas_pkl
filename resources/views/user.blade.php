        ...
        <div class="card card-large">
          ...
          <section class="user-navigation">
            ...
            <section class="edit-profile">
              <div class="form-groups">
                <label for="TanggalPelaksanaan">Masukkan Instansi</label>
                <input type="text" class="form-control" id="Instansi">
              </div>
              <div class="form-groups">
                <label for="TanggalPelaksanaan">Masukkan Unit Kerja</label>
                <input type="text" class="form-control" id="Unitkerja">
              </div>
              <div class="form-groups">
                <label for="TanggalPelaksanaan">Masukkan Jabatan</label>
                <input type="text" class="form-control" id="Jabatan">
              </div>
              <div class="form-groups">
                <label for="TanggalPelaksanaan">Masukkan Jenjang Pendidikan Terakhir</label>
                <input type="text" class="form-control" id="Jenjang">
              </div>
              <div class="form-groups">
                <label for="TanggalPelaksanaan">Masukkan Jurusan Pendidikan Terakhir</label>
